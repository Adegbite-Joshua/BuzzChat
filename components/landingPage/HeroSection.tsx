...
export default function HeroSection() {
  return (
    <section className='grid grid-cols-1 md:grid-cols-2 justify-evenly gap-2 items-center p-20 text-white bg-blue-600 md:h-[350px] relative'>
        ...
        <img src="/hero-section.png" alt="" className='h-[200px] border mx-auto w-full col-span-2' />
    </section>
  )
}
